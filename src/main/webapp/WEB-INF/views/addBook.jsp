								...
								<form action="<%=request.getContextPath()%>/insertBook" method="post" enctype="multipart/form-data" id="data_upload_form">
												...
												<div class="content_body add_book_content">
																...
																<div class="content_right">
																				...
																				<div>
																								<span>読み状況</span><span class="care care1">任意</span><select name="readStatus" value="${bookInfo.readStatus}">
																												<option value="">状況を入力してください</option>
																												<option value="1">未読</option>
																												<option value="2">既読中</option>
																												<option value="3">既読</option>
																								</select>
																				</div>
