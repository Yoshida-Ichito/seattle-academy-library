                            ...
                            <c:if test="${!(bookInfo.favorite.equals('like'))}">
                                <form method="GET" action="favorited" name="favorite">
                                   ...
                                   <c:if test="${bookInfo.readStatus.equals('1')}">
                                    <p>
                                        <input type="radio" name="site${bookInfo.bookId}" value="1" onchange="radio_func(this.value,${bookInfo.bookId})" checked>未読 <input type="radio" name="site${bookInfo.bookId}" value="2" onchange="radio_func(this.value,${bookInfo.bookId})">既読中 <input type="radio" name="site${bookInfo.bookId}" value="3" onchange="radio_func(this.value,${bookInfo.bookId})">既読
                                    </p>
                                </c:if>
                                <c:if test="${bookInfo.readStatus.equals('2')}">
                                    <p>
                                        <input type="radio" name="site${bookInfo.bookId}" value="1" onchange="radio_func(this.value,${bookInfo.bookId})" >未読 <input type="radio" name="site${bookInfo.bookId}" value="2" onchange="radio_func(this.value,${bookInfo.bookId})" checked>既読中 <input type="radio" name="site${bookInfo.bookId}" value="3" onchange="radio_func(this.value,${bookInfo.bookId})">既読
                                    </p>
                                </c:if>
